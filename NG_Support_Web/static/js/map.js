	...
	if (!Array.prototype.forEach)
		...
		markersData = {
			...
			{	
				...
				locationImg: 'assets/img/l-1.jpg',
				propertyprice: '$220',
				propertytype: 'Hotel',
			...
			},
			{
				...
				locationURL: 'single-listing-1.html',
				locationImg: 'assets/img/l-2.jpg',
				propertyprice: '$920',
			...
			},
			{
				...
				locationURL: 'single-listing-1.html',
				locationImg: 'assets/img/l-3.jpg',
				propertyprice: '$280',
				propertytype: 'Spa',
			...
			},
			{
				...
				locationURL: 'single-listing-1.html',
				locationImg: 'assets/img/l-4.jpg',
				propertyprice: '$240',
				propertytype: 'Food',
			...
			},
			{
				...
				locationURL: 'single-listing-1.html',
				locationImg: 'assets/img/l-5.jpg',
				propertyprice: '$820',
			...
			},
			{
				...
				locationURL: 'single-listing-1.html',
				locationImg: 'assets/img/l-6.jpg',
				propertyprice: '$260',
				propertytype: 'Music',
			...
			
			{
				...
				locationURL: 'single-listing-1.html',
				locationImg: 'assets/img/l-7.jpg',
				propertyprice: '$320',
				propertytype: 'Hotel',
				propertyname: '2014 Bastin Drive, USA',
				propertytime: 'mo'
			},
			{
				...
				locationURL: 'single-listing-1.html',
				locationImg: 'assets/img/l-8.jpg',
				propertyprice: '$150',
				propertytype: 'Wedding',
				propertyname: 'Mangalam Wedding Panner',
